...
flag_source_shape = 36 % 1 point 2 line 3 point-on-a-line 21 circle 31 circle
% each point on a rectangular 53
flag_src_diff_stfs=1; % 1 for different stfs; 0 - same stf
flag_station_shape = 31 % 1 line 2 circle 3 halfcircle 11 predefined RecPos
...
%     dt = 4.882812500000000e-08;
    ...
    transducer_length=0.062;  % transducer length in one row, 
    transducer_length2=0.051;  % transducer length in one col,  
    ...
    source_center_x = 0.00126; % not useful 0.00199
    ...
    r = 0.03;
    rec_x_center = 0.00126;
    rec_y_center = 0.000;
    receiver_number = 32; %  transducer_number in one row
    receiver_number2 = 1; 
    receiver_length=0.062;
    receiver_length2=0.051;
...
%     name_of_source_file = '/home/jiazeh/csp2d_base/DATA/sources/ricker_3src/line/0001';
    name_of_source_folder = strcat(sysHOME, '/csp2d_base/DATA/sources/verasv2_ext/')
    name_of_source_file = strcat(sysHOME, '/csp2d_base/DATA/sources/verasv2_ext/0000')
