...
flag_source_shape = 153 % 1 point 2 line 3 point-on-a-line 21 circle 31 circle
...
elseif flag_assign_value == 2 
    ...
    tank_half = 0.02;
    src_x_center = 0; %  0.015;
    src_y_center = 0;
    src_z_center = 0;

    transducer_number = 11;   %  transducer_number in one row, (num of col) 
    transducer_number2 = 11; %  transducer_number in one col, (num of row) 
    transducer_number3 = 1; %  transducer_number in one col, (num of z) 

    transducer_length=0.010;  % transducer length in one row, 
    transducer_length2=0.010;  % transducer length in one col,  
    transducer_length3=0.003;  % transducer length in one col,  
    ...
    rec_y_center = 0.000;
    rec_z_center = 0.003;
    receiver_number = 11; %  transducer_number in one row
    receiver_number2 = 11; 
    receiver_number3 = 1; 
    receiver_length=0.010;
    receiver_length2=0.010;
    receiver_length3=0;
...
%     
%     name_of_source_folder = strcat(sysHOME, '/csp2d_base/DATA/sources3d/3D_same_ricker_100k/')
%     name_of_source_file = strcat(sysHOME, '/csp2d_base/DATA/sources3d/3D_same_ricker_100k/0001')
